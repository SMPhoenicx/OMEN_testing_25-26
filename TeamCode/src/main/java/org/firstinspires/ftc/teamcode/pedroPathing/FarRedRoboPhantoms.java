...
@Autonomous(name="Far Red RoboPhantoms 🟥", group="B")
public class FarRedRoboPhantoms extends LinearOpMode {
...
//    private Servo tempServo = null;
    ...
    public void createPoses(){
        ...
        pickup2[0] = new Pose(144-54.684705882352944,8.392352941176465,Math.toRadians(0));
        pickup2[1] = new Pose(144-9.81,9.39,Math.toRadians(0));
        ...
        pickup3[0] = new Pose(144-0,0,Math.toRadians(90));
        pickup3[1] = new Pose(144-6.94,41.56,Math.toRadians(90));
