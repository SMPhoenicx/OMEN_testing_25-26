...
@Autonomous(name="Close Red CosmoBots 🟥", group="B")
public class CloseRedCosmo extends LinearOpMode {
...
//        startPose = new Pose(144-19.9,123.5,Math.toRadians(180-54));
        startPose = new Pose(124.1,123.5,Math.toRadians(180-54));
        ...
        gatePose[1] = new Pose(144-12.62,75.3,Math.toRadians(90));//14.62 75.3
        ...
        gate2Pose[0] = new Pose(144-31.73,56.58,Math.toRadians(180-270));
        gate2Pose[1] = new Pose(144-9.43,69.91,Math.toRadians(180-270));
