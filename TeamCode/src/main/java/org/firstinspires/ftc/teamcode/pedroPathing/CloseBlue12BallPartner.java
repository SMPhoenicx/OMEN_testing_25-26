...
//    private final PathConstraints shootConstraints = new PathConstraints(0.99, 500, 0.65, 0.8);
    ...
    public void createPoses(){
        ...
        pickup1[0] = new Pose(61.32,52.40,Math.toRadians(180));
        ...
        pickup2[1] = new Pose(15.832960773480665,64.18695359116022,Math.toRadians(152));
        ...
        junoPose[1] = new Pose(14.11878453038675,53.790055248618806,Math.toRadians(100));
...
//        junoPose[3] = new Pose(144-14.121546961325976,61.6767955801105,Math.toRadians(90));
        junoPose[3] = new Pose(14.121546961325976,65.6767955801105,Math.toRadians(90));
